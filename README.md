...
> As versões incrementais contêm apenas os mods adicionados ou atualizados entre versões. Elas devem ser aplicadas sobre uma instalação existente do modpack.
